...
The condition number for the predictor matrix is 63,202,332, which is well beyond our threshold. What does an acceptable condition number look like under an ideal circumstance? An ideal circumstance would be where the variables are generated by different processes. An example has been created below to demonstrate. 
